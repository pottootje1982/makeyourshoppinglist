...
public class UnitTest {
	...
	public void convertTo() {
		Unit unit1 = new Unit(QuantityType.Volume, UnitType.l, 2.0);
		Unit unit2 = new Unit(QuantityType.Volume, UnitType.dl, 3.0);
	...
	public void addDifferentUnits() {
		Unit unit1 = new Unit(QuantityType.Volume, UnitType.l, 2.0);
		Unit unit2 = new Unit(QuantityType.Volume, UnitType.ml, 1.0);
		assertEquals("2001ml", unit1.add(unit2).toString());
	}

	@Test
	public void addFourDifferentUnits() {
		Unit unit1 = new Unit(QuantityType.Volume, UnitType.l, 1.0);
		Unit unit2 = new Unit(QuantityType.Volume, UnitType.dl, 1.0);
		Unit unit3 = new Unit(QuantityType.Volume, UnitType.cl, 1.0);
		Unit unit4 = new Unit(QuantityType.Volume, UnitType.ml, 1.0);
